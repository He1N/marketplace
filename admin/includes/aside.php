        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview <?php echo ($Page === 'purchase_history') ? 'menu-open' : ''; ?>">
                        <a href="#" class="nav-link <?php echo ($Page === 'purchase_history') ? 'active' : ''; ?>">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="purchase_history.php" class="nav-link <?php echo ($Menu === 'purchase_history') ? 'active' : ''; ?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>View History</p>
                                </a>
                            </li>
